...
def __init__(self, vrOverlayCenterOffset=None):
        ...
        def text():
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':u'\ue02fBLITZ SMASH WORLD\ue02f',
                              'scale':1,
                              'maxWidth':0,
                              'position':(35,615),
                              'shadow':0.5,
                ...
                ##
                t = bs.newNode('text',
                       attrs={ 'text':u'\ue02f OWNER \ue02f :- \ue048BLITZ\ue048 \ue043 PARTNER \ue043 :- \ue043CONQUEROR\ue043',
                              'scale':1.3,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':u'\ue043CONTACT/COMPLAIN/SUGGESTION IN DISCORD\ue043',
                              'scale':1,
                              'maxWidth':0,
                              'position':(0,138),
                              'color':((0+random.random()*1.0),(0+random.random()*1.0),(0+random.random()*1.0)),
                ...
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':u'\ue04cJOIN OUR DISCORD SERVER USING STATS BUTTON\ue04c',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,139),
                              'shadow':0.5,
                ...
                ##
                t = bs.newNode('text',
                       attrs={ 'text':u'\ue047Thanks To PCModder\ue047',
                               'scale': 1,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
