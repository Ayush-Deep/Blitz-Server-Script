            ...
            if not self._dead:
                ...
                if not killed:
                    ...
                    if (self.heldCount > 0
                        ...
                        kill_msg = u'\ue00c '+'You Killed '+killedPlayer.getName()+u' \ue00c'
                    else:
                ...
                if (killed and activity is not None
                    ...
                    if killed:
                        #bsUtils.PopupText(killerPlayer.getName()+'Killed \n the Noob',color=(1,1,1),scale=1.2,position=self.node.position).autoRetain()
                        ...
                        #bs.screenMessage(killerPlayer.getName()+'Noob got Killed')
