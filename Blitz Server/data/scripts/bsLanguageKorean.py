...
values = {
    ...
    'settingsWindowAdvanced':{
        ...
        'translationInformMe':'언어 업데이트 알림 활성화',
    ...
    'store':{
        ...
        'bombSquadProNewDescriptionText':('• 광고 제거와 게임 중 자성 화면 제거\n'
                                          '• 추가 게임 설정 사용 가능\n'
                                          '• 이것들도 제공됩니다:'),
        'buyText':'구입',
        'charactersText':'캐릭터',
        ...
        'totalWorthText':'*** ${TOTAL_WORTH}만큼 가치가 있음! ***',
        'upgradeQuestionText':'계정을 승급시키겠습니까?',
