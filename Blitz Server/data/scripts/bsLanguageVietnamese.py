...
values = {
    ...
    'gatherWindow':{
        ...
        'joinPublicPartyDescriptionText':'Gia nhập một tổ đội công cộng:',
        'localNetworkDescriptionText':'Gia nhập một tổ đội trên mạng của bạn:',
        'localNetworkText':'Mạng Nội bộ',
        'makePartyPrivateText':'Làm tổ đội của tôi riêng tư',
        'makePartyPublicText':'Làm tổ đội của tôi trở nên công cộng',
        ...
        'wifiDirectDescriptionBottomText':('Nếu tất cả các thiết bị có bảng điều khiển \'Wi-Fi Direct\', họ sẽ có thể sử dụng nó để tìm\n'
                                           ' và kết nối với nhau.  Khi tất cả các thiết bị được kết nối, bạn có thể tạo thành các tổ đội\n'
                                           ' ở đây sử dụng tab \'Mạng cục bộ\', giống như với mạng Wi-Fi thông thường.\n'
                                           '\n'
                                           ' Để có kết quả tốt nhất, máy chủ Wi-Fi Direct cũng phải là máy chủ của tổ đội ${APP_NAME}.'),
    ...
    'internal':{
        ...
        'serverRestartingText':'ĐANG KHỞI ĐỘNG LẠI. Vui lòng tham gia lại trong một lát...',
    ...
    'kioskWindow':{
        ...
        'hardText':'Khó',
        'mediumText':'Trung bình',
        'singlePlayerExamplesText':'Đánh máy ví dụ',
        'versusExamplesText':'Ví dụ Versus'
    },
    'languageSetText':'Ngôn ngữ bây giờ là "${LANGUAGE}".',
    'lapNumberText':'Vòng ${CURRENT}/${TOTAL}',
    'lastGamesText':'(${COUNT} trò chơi vừa qua)',
    'leaderboardsText':'Bảng xếp hạng',
    'league':{
        'allTimeText':'Tất cả thời gian',
        'currentSeasonText':'Mùa hiện tại (${NUMBER})',
        'leagueFullText':'Giải đấu ${NAME}',
        'leagueRankText':'Thứ hạng Giải đấu',
        'leagueText':'Giải đấu',
        'rankInLeagueText':'#${RANK}, giải đấu ${NAME}${SUFFIX}',
        'seasonEndedDaysAgoText':'Mùa giải đã kết thúc ${NUMBER} ngày trước.',
        'seasonEndsDaysText':'Kết thúc mùa trong ${NUMBER} ngày.',
        'seasonEndsHoursText':'Mùa giải sẽ kết thúc trong ${NUMBER} giờ.',
        'seasonEndsMinutesText':'Mùa giải kết thúc trong ${NUMBER} phút.',
    ...
    'noAchievementsRemainingText':'không có gì hết',
