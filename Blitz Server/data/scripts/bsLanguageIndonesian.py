...
values = {
    ...
    'getTicketsWindow':{
        ...
        'versionTooOldText':'Maaf, versi permainan ini terlalu usang; silakan perbarui dengan yang terbaru.',
    ...
    'translations':{
        ...
        'serverResponses':{
            ...
            'Your account was rejected. Are you signed in?':'Akunmu ditolak. Apakah kau terdaftar?',
    ...
    'tutorial':{
        ...
        'phrase07Text':'Lihat? Kamu cuman diam, jadi ${NAME} cuman kegelian',
        ...
        'randomName1Text':'Inan',
        'randomName2Text':'Ingki',
        'randomName3Text':'Galang',
        'randomName4Text':'Rafka',
