...
values = {
    'accountSettingsWindow':{
        'accountNameRules':'Numele Contului nu poate conține emoji sau alte semne speciale',
        ...
        'changeOncePerSeason':'Acesta poate fi schimbat  o singura data pe sezon',
        'changeOncePerSeasonError':'Trebuie sa astepti pana urmatorul sezon ca sa schimbi asta din nou (${NUM} zile)',
        ...
        'nameChangeConfirm':'Schimbăti numele contului in ${NAME}?',
        ...
        'setAccountName':'Seteazaă numele contului',
        'setAccountNameDesc':'Selectati numele pentru a afisa pentru contul tau.Tu poti folosi numele de la unul dintre conturile tale legate sau sa creezi un nume unic si personalizat',
    ...
    'autoText':'Automat',
    'backText':'Înapoi',
    'banThisPlayerText':'Interzice acest jucator',
    ...
    'chatMuteText':'Dezactiveaza chat-ul',
    'chatMutedText':'Chat dezactivat',
    'chatUnMuteText':'Activeaza chat-ul',
    ...
    'exportSuccessText':'\'${NAME}\' exportat',
    ...
    'gameListWindow':{
        ...
        'cantShareDefaultText':'Nu poti trimite playlistul default',
